...
import { generated_path, max_top_levels } from './const.js';
...
export const run_path = `${generated_path}/run_${format_run_folder_name(new Date)}`;
...
export function generate_program(): string | undefined {
